...
const Card = ({name, price, imageUrl, onClickPlus, onClickFavorite}) => {

    return (
        <div className={styles.card}>

            <svg onClick={onClickFavorite} className={styles.hard} width="21" height="19" viewBox="0 0 21 19" fill="none"
